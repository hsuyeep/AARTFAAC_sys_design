...
\noindent \textbf  {Monitoring Interface:}
 The control  system allows monitoring
the  various  subsystems at  fine  granularity,  making  it useful  to  localize
problems  within  the system  by  examining  the  email reports.   For  monitoring
data flow         on        a         hardware        level         we        use
...
% \begin {minipage}{0.4\textwidth}
   ...
   \caption{(Left) An uncalibrated image from the AARTFAAC-12 system demonstrating the
     hardware data routing and correlator functioning. (Right) A calibrated image from the AARTFAAC-6 system, with a bandwidth of ~1.5MHz and 1second integration.}
